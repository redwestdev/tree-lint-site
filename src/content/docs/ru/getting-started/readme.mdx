...
> Tree-lint не привязан к конкретной архитектуре — вы описываете свою архитектуру в конфиге, а Tree-lint проверяет соответствие. Поддерживает Deep Tree, FSD, монорепо и любые другие подходы, при которых можно выделить отдельные слои и сущности.
